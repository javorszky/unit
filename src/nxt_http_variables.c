...
static nxt_int_t
nxt_http_var_request_time(nxt_task_t* task,
                          nxt_str_t* str,
                          void* ctx,
                          void* data);
static nxt_int_t
...
static nxt_int_t
nxt_http_var_request_uri(nxt_task_t* task,
                         nxt_str_t* str,
                         void* ctx,
                         void* data);
static nxt_int_t
...
static nxt_int_t
nxt_http_var_remote_addr(nxt_task_t* task,
                         nxt_str_t* str,
                         void* ctx,
                         void* data);
static nxt_int_t
nxt_http_var_time_local(nxt_task_t* task,
                        nxt_str_t* str,
                        void* ctx,
                        void* data);
static u_char*
nxt_http_log_date(u_char* buf,
                  nxt_realtime_t* now,
                  struct tm* tm,
                  size_t size,
                  const char* format);
static nxt_int_t
nxt_http_var_request_line(nxt_task_t* task,
                          nxt_str_t* str,
                          void* ctx,
                          void* data);
static nxt_int_t
nxt_http_var_request_id(nxt_task_t* task,
                        nxt_str_t* str,
                        void* ctx,
                        void* data);
static nxt_int_t
...
static nxt_int_t
nxt_http_var_body_bytes_sent(nxt_task_t* task,
                             nxt_str_t* str,
                             void* ctx,
                             void* data);
static nxt_int_t
...
static nxt_int_t
nxt_http_var_user_agent(nxt_task_t* task,
                        nxt_str_t* str,
                        void* ctx,
                        void* data);
static nxt_int_t
nxt_http_var_response_connection(nxt_task_t* task,
                                 nxt_str_t* str,
                                 void* ctx,
                                 void* data);
static nxt_int_t
nxt_http_var_response_content_length(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t
nxt_http_var_response_transfer_encoding(nxt_task_t* task,
                                        nxt_str_t* str,
                                        void* ctx,
                                        void* data);
static nxt_int_t
...
static nxt_int_t
nxt_http_var_response_header(nxt_task_t* task,
                             nxt_str_t* str,
                             void* ctx,
                             void* data);
                          ...
                          void* data)
{
  ...
  p = nxt_sprintf(str->start,
                  str->start + NXT_TIME_T_LEN,
                  "%T.%03M",
                  (nxt_time_t)ms / 1000,
                  ms % 1000);
...
nxt_http_var_time_local(nxt_task_t* task, nxt_str_t* str, void* ctx, void* data)
{
  ...
  str->length =
    nxt_thread_time_string(task->thread, &date_cache, str->start) - str->start;
                                     ...
                                     void* data)
{
  ...
  if (r->resp.content_length_n >= 0) {
    ...
    p = nxt_sprintf(
      str->start, str->start + NXT_OFF_T_LEN, "%O", r->resp.content_length_n);
