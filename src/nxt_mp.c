...
static const int nxt_lg2_tab64[64] = {63, 0, 58, 1, 59, 47, 53, 2, 60, 39, 48,
    27, 54, 33, 42, 3, 61, 51, 37, 40, 49, 18, 28, 20, 55, 30, 34, 11, 43, 14,
    22, 4, 62, 57, 46, 52, 38, 26, 32, 41, 50, 36, 17, 19, 29, 10, 13, 21, 56,
...
nxt_mp_test_sizes(size_t cluster_size, size_t page_alignment, size_t page_size,
    ...
    valid = nxt_expect(1,
        (nxt_is_power_of_two(page_alignment) && nxt_is_power_of_two(page_size)
