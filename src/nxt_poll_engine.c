...
static nxt_int_t
nxt_poll_create(nxt_event_engine_t* engine,
                nxt_uint_t mchanges,
                nxt_uint_t mevents);
static void
...
static void
nxt_poll_change(nxt_event_engine_t* engine,
                nxt_fd_event_t* ev,
                nxt_uint_t op,
                nxt_uint_t events);
static nxt_int_t
...
nxt_poll_fd_hash_test(nxt_lvlhsh_query_t* lhq, void* data)
{
  ...
  nxt_alert(&engine->task,
            ...
            phe->fd,
            engine->u.poll.set[phe->index].fd);
