...
static IV
nxt_perl_psgi_layer_stream_pushed(pTHX_ PerlIO* f,
                                  const char* mode,
                                  SV* arg,
                                  PerlIO_funcs* tab);
static IV
...
static PerlIO*
nxt_perl_psgi_layer_stream_dup(pTHX_ PerlIO* f,
                               PerlIO* o,
                               CLONE_PARAMS* param,
                               int flags);
static IV
...
{
  return PerlIO_openn(
    aTHX_ "NGINX_Unit_PSGI_Layer_Stream", mode, 0, 0, 0, NULL, 1, &arg_rv);
}
