...
nxt_int_t
nxt_clone_credential_setgroups(nxt_task_t* task,
                               pid_t child_pid,
                               const char* str);
nxt_int_t
nxt_clone_credential_map_set(nxt_task_t* task,
                             const char* mapfile,
                             pid_t pid,
...
nxt_int_t
nxt_clone_credential_map_write(nxt_task_t* task,
                               const char* mapfile,
                               pid_t pid,
                               u_char* mapinfo);
...
nxt_int_t
nxt_clone_credential_map(nxt_task_t* task,
                         pid_t pid,
                         ...
                         nxt_clone_t* clone)
{
  ...
  ret = nxt_clone_credential_map_set(
    task, "uid_map", pid, app_creds->uid, default_host_uid, &clone->uidmap);
  ...
  ret = nxt_clone_credential_map_set(task,
                                     "gid_map",
                                     pid,
                                     app_creds->base_gid,
                                     default_host_gid,
