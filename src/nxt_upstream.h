...
typedef void (
    *nxt_upstream_peer_ready_t)(nxt_task_t *task, nxt_upstream_server_t *us);
typedef void (
    *nxt_upstream_peer_error_t)(nxt_task_t *task, nxt_upstream_server_t *us);
...
typedef void (
    *nxt_upstream_server_get_t)(nxt_task_t *task, nxt_upstream_server_t *us);
