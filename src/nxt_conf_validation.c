...
static nxt_int_t
nxt_conf_vldt_type(nxt_conf_validation_t* vldt,
...
static nxt_int_t
nxt_conf_vldt_var(nxt_conf_validation_t* vldt,
                  const nxt_str_t* name,
                  nxt_str_t* value);
static nxt_int_t
nxt_conf_vldt_if(nxt_conf_validation_t* vldt,
                 nxt_conf_value_t* value,
                 void* data);
...
static nxt_int_t
nxt_conf_vldt_mtypes(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
nxt_conf_vldt_mtypes_type(nxt_conf_validation_t* vldt,
                          nxt_str_t* name,
                          nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_mtypes_extension(nxt_conf_validation_t* vldt,
                               nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_listener(nxt_conf_validation_t* vldt,
                       nxt_str_t* name,
                       nxt_conf_value_t* value);
#if (NXT_TLS)
static nxt_int_t
...
static nxt_int_t
nxt_conf_vldt_ticket_key(nxt_conf_validation_t* vldt,
                         nxt_conf_value_t* value,
                         void* data);
static nxt_int_t
...
#endif
static nxt_int_t
nxt_conf_vldt_action(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
nxt_conf_vldt_pass(nxt_conf_validation_t* vldt,
                   nxt_conf_value_t* value,
                   void* data);
static nxt_int_t
nxt_conf_vldt_return(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
nxt_conf_vldt_share(nxt_conf_validation_t* vldt,
                    nxt_conf_value_t* value,
                    void* data);
static nxt_int_t
nxt_conf_vldt_share_element(nxt_conf_validation_t* vldt,
                            nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_proxy(nxt_conf_validation_t* vldt,
                    nxt_conf_value_t* value,
                    void* data);
static nxt_int_t
nxt_conf_vldt_python(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
...
nxt_conf_vldt_listen_threads(nxt_conf_validation_t* vldt,
                             ...
                             void* data);
static nxt_int_t
nxt_conf_vldt_threads(nxt_conf_validation_t* vldt,
                      nxt_conf_value_t* value,
                      void* data);
static nxt_int_t
nxt_conf_vldt_thread_stack_size(nxt_conf_validation_t* vldt,
                                ...
                                void* data);
static nxt_int_t
nxt_conf_vldt_routes(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
nxt_conf_vldt_routes_member(nxt_conf_validation_t* vldt,
                            nxt_str_t* name,
                            nxt_conf_value_t* value);
static nxt_int_t
...
static nxt_int_t
nxt_conf_vldt_response_header(nxt_conf_validation_t* vldt,
                              nxt_str_t* name,
                              nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_app_name(nxt_conf_validation_t* vldt,
                       nxt_conf_value_t* value,
                       void* data);
static nxt_int_t
nxt_conf_vldt_forwarded(nxt_conf_validation_t* vldt,
                        nxt_conf_value_t* value,
                        void* data);
static nxt_int_t
nxt_conf_vldt_listen_backlog(nxt_conf_validation_t* vldt,
                             ...
                             void* data);
static nxt_int_t
nxt_conf_vldt_app(nxt_conf_validation_t* vldt,
                  nxt_str_t* name,
                  nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_object(nxt_conf_validation_t* vldt,
                     nxt_conf_value_t* value,
                     void* data);
static nxt_int_t
nxt_conf_vldt_processes(nxt_conf_validation_t* vldt,
                        nxt_conf_value_t* value,
                        void* data);
static nxt_int_t
...
nxt_conf_vldt_array_iterator(nxt_conf_validation_t* vldt,
                             ...
                             void* data);
static nxt_int_t
nxt_conf_vldt_environment(nxt_conf_validation_t* vldt,
                          nxt_str_t* name,
                          nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_targets_exclusive(nxt_conf_validation_t* vldt,
                                ...
                                void* data);
static nxt_int_t
nxt_conf_vldt_targets(nxt_conf_validation_t* vldt,
                      nxt_conf_value_t* value,
                      void* data);
static nxt_int_t
nxt_conf_vldt_target(nxt_conf_validation_t* vldt,
                     nxt_str_t* name,
                     nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_argument(nxt_conf_validation_t* vldt, nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_php(nxt_conf_validation_t* vldt,
                  nxt_conf_value_t* value,
                  void* data);
static nxt_int_t
nxt_conf_vldt_php_option(nxt_conf_validation_t* vldt,
                         nxt_str_t* name,
                         nxt_conf_value_t* value);
static nxt_int_t
...
static nxt_int_t
nxt_conf_vldt_upstream(nxt_conf_validation_t* vldt,
                       nxt_str_t* name,
                       nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_server(nxt_conf_validation_t* vldt,
                     nxt_str_t* name,
                     nxt_conf_value_t* value);
static nxt_int_t
nxt_conf_vldt_server_weight(nxt_conf_validation_t* vldt,
                            ...
                            void* data);
static nxt_int_t
nxt_conf_vldt_access_log(nxt_conf_validation_t* vldt,
                         nxt_conf_value_t* value,
                         void* data);

static nxt_int_t
nxt_conf_vldt_isolation(nxt_conf_validation_t* vldt,
                        nxt_conf_value_t* value,
                        void* data);
static nxt_int_t
...
#if (NXT_HAVE_NJS)
static nxt_int_t
nxt_conf_vldt_js_module(nxt_conf_validation_t* vldt,
                        nxt_conf_value_t* value,
                        void* data);
static nxt_int_t
                         ...
                         void* data)
{
  ...
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_ticket_key_element);
  }
                          ...
                          nxt_conf_value_t* value)
{
  ...
  ret = nxt_conf_vldt_type(
    vldt, name, value, NXT_CONF_VLDT_STRING | NXT_CONF_VLDT_ARRAY);
  if (ret != NXT_OK) {
    return ret;
  }
  ...
  *ctx->type = *name;
  ...
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_mtypes_extension);
  }
                               ...
                               nxt_conf_value_t* value)
{
  ...
  return nxt_http_static_mtypes_hash_add(
    ctx->pool, &ctx->hash, &exten, ctx->type);
}
                    ...
                    void* data)
{
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    ...
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_share_element);
  }
                    ...
                    void* data)
{
  ...
  return nxt_conf_vldt_error(
    vldt, "The \"proxy\" address is invalid \"%V\"", &name);
}
                     ...
                     void* data)
{
  ...
  return nxt_conf_vldt_object(
    vldt, value, nxt_conf_vldt_python_notargets_members);
}
                          ...
                          void* data)
{
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_python_path_element);
  }
                     ...
                     void* data)
{
  ...
  return nxt_conf_vldt_object_iterator(
    vldt, value, &nxt_conf_vldt_routes_member);
}
                            ...
                            nxt_conf_value_t* value)
{
  ...
  if (first < pattern.length && pattern.start[first] == '~') {
    ...
    if (nxt_slow_path(re == NULL)) {
      ...
      return nxt_conf_vldt_error(
        vldt, "Invalid regular expression: %s", err.msg);
    }
                          ...
                          void* data)
{
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    ...
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_certificate_element);
  }
                        ...
                        void* data)
{
  ...
  ret = nxt_conf_map_object(vldt->pool,
                            value,
                          ...
                          void* data)
{
  ...
  if (cgpath.length >= NXT_MAX_PATH_LEN - strlen(NXT_CGROUP_ROOT) - 1) {
    return nxt_conf_vldt_error(
      vldt, "The cgroup path \"%V\" is too long.", &cgpath);
  }
  ...
  if (cgpath.length == 0 || strstr(path, "/../") != NULL) {
    return nxt_conf_vldt_error(
      vldt, "The cgroup path \"%V\" is invalid.", &cgpath);
  }
...
nxt_conf_vldt_clone_uidmap(nxt_conf_validation_t* vldt, nxt_conf_value_t* value)
{
  ...
  ret =
    nxt_conf_vldt_object(vldt, value, (void*)nxt_conf_vldt_app_procmap_members);
  if (nxt_slow_path(ret != NXT_OK)) {
    return ret;
  }
                     ...
                     nxt_conf_value_t* value)
{
  ...
  return nxt_conf_vldt_object(
    vldt, value, nxt_conf_vldt_upstream_server_members);
}
                        ...
                        void* data)
{
  if (nxt_conf_type(value) == NXT_CONF_ARRAY) {
    return nxt_conf_vldt_array_iterator(
      vldt, value, &nxt_conf_vldt_js_module_element);
  }
