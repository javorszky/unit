...
static void
nxt_conn_proxy_read_process(nxt_task_t* task,
                            nxt_conn_proxy_t* p,
                            nxt_conn_t* source,
                            nxt_conn_t* sink);
static void
...
static void
nxt_conn_proxy_write_process(nxt_task_t* task,
                             nxt_conn_proxy_t* p,
                             nxt_conn_t* sink,
                             nxt_conn_t* source);
static void
...
static void
nxt_conn_proxy_shutdown(nxt_task_t* task,
                        nxt_conn_proxy_t* p,
                        nxt_conn_t* source,
                        nxt_conn_t* sink);
static void
...
nxt_conn_proxy_complete(nxt_task_t* task, nxt_conn_proxy_t* p)
{
  ...
  nxt_debug(p->client->socket.task,
            "conn proxy complete %d:%d",
            p->client->socket.fd,
            p->peer->socket.fd);
