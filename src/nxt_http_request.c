...
static const nxt_http_request_state_t nxt_http_request_init_state nxt_aligned(
    64)
    = {
...
static const nxt_http_request_state_t nxt_http_request_body_state nxt_aligned(
    64)
    = {
