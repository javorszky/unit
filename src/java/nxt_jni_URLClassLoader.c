...
nxt_java_newURLClassLoader(JNIEnv* env, int url_count, char** urls)
{
  ...
  return (*env)->NewObject(
    env, nxt_java_URLClassLoader_class, nxt_java_URLClassLoader_ctor, jurls);
}

jobject
nxt_java_newURLClassLoader_parent(JNIEnv* env,
                                  int url_count,
                                  char** urls,
                                  jobject parent)
{
...
nxt_java_loadClass(JNIEnv* env, jobject cl, const char* name)
{
  ...
  return (*env)->CallObjectMethod(
    env, cl, nxt_java_URLClassLoader_loadClass, jname);
}
