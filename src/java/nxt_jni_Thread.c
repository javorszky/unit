...
nxt_java_setContextClassLoader(JNIEnv* env, jobject cl)
{
  ...
  thread = (*env)->CallStaticObjectMethod(
    env, nxt_java_Thread_class, nxt_java_Thread_currentThread);
  ...
  (*env)->CallVoidMethod(
    env, thread, nxt_java_Thread_setContextClassLoader, cl);
}
...
nxt_java_getContextClassLoader(JNIEnv* env)
{
  ...
  return (*env)->CallObjectMethod(
    env, thread, nxt_java_Thread_getContextClassLoader);
}
