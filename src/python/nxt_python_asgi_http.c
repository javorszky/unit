...
static void
nxt_py_asgi_http_set_result(nxt_py_asgi_http_t* http,
                            PyObject* future,
                            PyObject* msg);
static PyObject*
...
nxt_py_asgi_http_send(PyObject* self, PyObject* dict)
{
  ...
  nxt_unit_req_debug(
    http->req, "asgi_http_send type is '%.*s'", (int)type_len, type_str);
...
nxt_py_asgi_http_response_start(nxt_py_asgi_http_t* http, PyObject* dict)
{
  ...
  rc = nxt_unit_response_init(http->req,
                              PyLong_AsLong(status),
...
nxt_py_asgi_http_response_body(nxt_py_asgi_http_t* http, PyObject* dict)
{
  ...
  if (body != NULL) {
    ...
    nxt_unit_req_debug(
      http->req, "asgi_http_response_body: 0, %d", (more_body == Py_True));
...
fail:
  ...
  exc = PyObject_CallFunctionObjArgs(
    PyExc_RuntimeError, nxt_py_failed_to_send_body_str, NULL);
